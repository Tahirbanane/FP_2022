...
mu2 = [np.log((I1[0])/ I2[0])/d_s,
np.log((I1[1])/  I2[1])/d_s,
np.log((I1[2])/  I2[2])/d_s,
np.log((I1[3])/  I2[3])/d_s,
np.log((I1[4])/  I2[4])/d_s,
np.log((I1[5])/  I2[5])/d_s,
np.log((I1[6])/  I2[6])/d_nd,
np.log((I1[7])/  I2[7])/d_hd,
np.log((I1[8])/  I2[8])/d_nd,
np.log((I1[9])/  I2[9])/d_nd,
np.log((I1[10])/ I2[10])/d_hd,
np.log((I1[11])/ I2[11])/d_nd,]
...
mu3 = [np.log((I1[0])/ I3[0])/d_s,
np.log((I1[1])/  I3[1])/d_s,
np.log((I1[2])/  I3[2])/d_s,
np.log((I1[3])/  I3[3])/d_nd,
np.log((I1[4])/  I3[4])/d_hd,
np.log((I1[5])/  I3[5])/d_nd]

mu_3 = np.mean(mu3)

print(f'mu 3: {mu3}')
print(f'Intensitäten: {I_3}')
print(f'mu 3 mit: {mu_3}')
